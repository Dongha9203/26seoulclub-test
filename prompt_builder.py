        ...
        "properties": {
            "answer": {
                ...
                "description": (
                    ...
                    "\"안녕하세요\", \"좋은 질문이에요\", \"~정보를 안내해 드릴게요!\", "
                    "\"~말씀드릴게요\" 같은 모든 형태의 서론 문장은 생략하고 "
                    "핵심 내용부터 바로 시작합니다. "
                    "\"도움이 됐으면 합니다\" 같은 마무리 인사도 생략합니다."
                ),
            },
            "sentiment_score": {
                "type": "number",
...
def build_system_prompt(tone_instruction: str, search_results: List[SearchResult],
    ...
    guardrails = [
        ...
        "- 답변은 핵심 정보만 3문장 이내로 간결하게 작성하세요. \"~안내해 드릴게요!\", \"~말씀드릴게요\" 같은 서론 문장 없이 핵심 내용부터 바로 시작하고, 마무리 감사 표현도 생략하세요.",
